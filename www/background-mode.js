 ...
 * notification status
 */
exports.isOpenNotification = function(callback)
{
    if (this._isAndroid)
    {
        cordova.exec(callback, null, 'BackgroundModeExt', 'isOpenNotification', []);
    }
    else
    {
        callback(true);
 ...
 */
exports.openNotificationSettings = function()
{
    if (this._isAndroid)
    {
        cordova.exec(null, null, 'BackgroundModeExt', 'openNotificationSettings', []);
    }
};
